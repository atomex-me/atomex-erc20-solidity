...
contract AtomicSwap is ReentrancyGuard {
    ...
    function initiate (bytes32 _hashedSecret, address _contract, address _participant, uint256 _refundTimestamp, uint256 _countdown, uint256 _value, uint256 _payoff, bool _active)
